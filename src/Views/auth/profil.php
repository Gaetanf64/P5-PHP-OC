    ...
    <main>
        <div class="container">
            ...
            <form action="" method="POST">
                ...
                <!-- <input required type="password" name="password" placeholder="Mot de passe" value="<?= $userUpdate->getPassword() ?>" class=" input1" /> -->
                <button type="submit" name="editBtn" class="btn">Enregistrer</button>
            </form>
